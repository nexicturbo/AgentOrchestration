...
class AgentSandbox:
    def __init__(self, base_path: Optional[Union[str, Path]] = None):
        raw_base_path = base_path or tempfile.mkdtemp(prefix="ao_sandbox_")
        self.base_path = Path(raw_base_path).resolve()
    ...
    def create(
        ...
        try:
            ...
            raise ValueError("sandbox path escapes base path") from exc
